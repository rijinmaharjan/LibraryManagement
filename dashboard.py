...
requestlabelicon = PhotoImage(file="requestlogo.png")
borrowlabelicon = PhotoImage(file="borrowlistlogo.png")
...
book_label = Label(book_frame, text="All Books", image=newbook_icon, compound=LEFT, font=("Arial", 16, "bold"), bg="#0a0102",fg='white')
...
requests_label = Label(requests_frame, text="Requests",image=requestlabelicon, compound=LEFT, font=("Arial", 16, "bold"), bg="#0a0102",fg='white')
...
borrowers_label = Label(borrowers_frame, text="Your Borrowed Books", image=borrowlabelicon, compound=LEFT,font=("Arial", 16, "bold"), bg="#0a0102",fg='white')
